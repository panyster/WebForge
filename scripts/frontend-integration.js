 ...
 * This file demonstrates how to integrate Web3forge with a web frontend
 */

// For React/Vue/Angular applications
export class Web3forgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Web3forgeClient(provider, contractAddress);
